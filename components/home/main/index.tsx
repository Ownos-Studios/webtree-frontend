...
import ChatIconBlack from "@/assets/svg/chatIconBlack";
          ...
          links={
            <>
              ...
              {  <LinkBtn
                  platform={"github"}
                  link={async () => {
                    const url = await GetVerificationLink("github-username");
              ...
              {  <LinkBtn
                  platform={"twitter"}
                  link={async () => {
                    const url = await GetVerificationLink("twitter-username");
                ...
                {  <LinkBtn
                  platform={"codeforces"}
                  link={async () => {
                    const url = await GetVerificationLink("codeforces-rating");
